...
RESULTS_DIR = os.path.join(os.path.dirname(__file__), '../approach_results/combined')
...
def transcribe(model: WhisperForConditionalGeneration, 
               ...
               prompt_ru: str) -> str:
    '''
    Транскрибирует аудиофайл с использованием начального промпта, beam search 
    и подавления ошибочных токенов
